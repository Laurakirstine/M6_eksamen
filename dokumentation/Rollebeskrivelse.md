...
+ Kodning af tilknytning til database (Nanna)
+ Kodning af side 2 - Se alle opgaver (Nanna)
+ Kodning af side 3 - Se igangværende opgaver (Laura)
+ Kodning af side 4 - Se afsluttede opgaver (Laura)
+ Layout design i CSS - farver, skrifttyper, placering på webside etc. (Løbende både Laura og Nanna)
+ Kodning af filtrerings funktion (Nanna)
